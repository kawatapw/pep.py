...
def loginBanned():
	...
	packets += notification("You are banned. You can appeal after one month since your ban by sending an email to accounts@kawata.pw from the email address you've used to sign up.")
	return packets

def loginLocked():
	packets = packetHelper.buildPacket(packetIDs.server_userID, [[-1, dataTypes.SINT32]])
	packets += notification("Your account is locked. You can't log in, but your profile and scores are still visible from the website. If you want to unlock your account, send an email to accounts@kawata.pw from the email address you've used to sign up.")
	return packets
