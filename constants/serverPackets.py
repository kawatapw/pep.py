...
def loginBanned():
	...
	packets += notification("You are banned. You can appeal after 15 days since your ban by sending an email to accounts@kawata.pw from the email address you've used to sign up.")
	return packets
