	...
	def asyncPost(self):
		...
		if requestTokenString is None:
			...
			try:
				...
				responseData += serverPackets.notification("You don't seem to be logged into Kawata anymore... This is common during server restarts, trying to log you back in.")
