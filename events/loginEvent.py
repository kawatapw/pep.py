...
def handle(tornadoRequest):
    ...
    try:
        ...
        user_db = glob.db.fetch(
            "SELECT id, privileges, silence_end, donor_expire FROM users "
            ...
            if donor_expire - int(time.time()) <= 86400 * 3:
                ...
                responseToken.enqueue(
                    serverPackets.notification(
                        "Your supporter status expires in {}! Following this, you will lose your supporter privileges (such as the further profile customisation options, name changes or profile wipes) and will not be able to access supporter features. If you wish to keep supporting Kawata and you don't want to lose your donor privileges, you can donate again by clicking on 'Donate' on our website.".format(
                            expireIn,
                        ),
                    ),
                )
